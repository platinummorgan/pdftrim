...
3. **Load PDF for Preview**
   ...
   **Right Pages (even):**
   ...
   This repository includes a modern Next.js frontend with AdSense integration, SEO, and a client-side PDF trimming UI. See the `frontend/` folder for the full implementation and instructions.
   ...
   **Made with ❤️ for book digitization enthusiasts**
npm run build
